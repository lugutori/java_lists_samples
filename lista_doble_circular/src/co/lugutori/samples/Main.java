...
class Main {
    public static void main(String[] args){
        ...
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        System.out.println("Testing Adding on Double Circular Linked List");
        list.add(4);
        list.add(2);
        list.add(5);
        list.add(1);
        ...
        System.out.println("Testing removing on Double Circular Linked List");
        list.removePos(4);
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        list.removePos(3);
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        ...
        list.removePos(0);
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        System.out.println("Testing Adding w/position on Double Circular Linked List");
        list.add(0,10);
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        list.add(1,20);
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        ...
        list.add(7,80);
        System.out.println("doubleCircularLinkedList: " + list + " size: " + list.getSize());
        System.out.println("Testing Finding on Double Circular Linked List");
